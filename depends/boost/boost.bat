...
call bootstrap.bat
b2 toolset=msvc variant=debug link=static --with-thread --with-date_time --with-regex --with-random
b2 toolset=msvc variant=release link=static --with-thread --with-date_time --with-regex --with-random
